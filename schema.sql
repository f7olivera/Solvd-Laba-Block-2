...
-- -----------------------------------------------------
-- Table `Building_company`.`Buildings types`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Building_company`.`Buildings types` (
  `id` INT NOT NULL,
  `capacity` INT NULL,
  `floors` INT NULL,
...
CREATE TABLE IF NOT EXISTS `Building_company`.`Buildings` (
  ...
  `Buildings types_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  ...
  INDEX `fk_Buildings_Buildings types1_idx` (`Buildings types_id` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_Buildings_Buildings types1`
    FOREIGN KEY (`Buildings types_id`)
    REFERENCES `Building_company`.`Buildings types` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
